CREATE (powergraph:Publishing_House {name:"Powergraph"})
CREATE (RKosik:Author {name:'Rafał', surname:'Kosik', born:date("1971-10-08")})
CREATE (FNiN_GNL:Book {
    title:"Felix, Net i Nika oraz Gang Niewidzialnych Ludzi", 
    cover_photo:"https://powergraph.pl/uploads/catalog/product/cover/33/large_Felix_GNL_front_500.jpg", 
    genres:["fantasy", "science-fiction", "teen"], 
    description:"(#1 w serii)
...
CREATE (FNiN_TMK:Book {
    title:"Felix, Net i Nika oraz Teoretycznie Możliwa Katastrofa", 
    cover_photo:"https://powergraph.pl/uploads/catalog/product/cover/34/large_Felix_TMK_front_500.jpg", 
    genres:["fantasy", "science-fiction", "teen"], 
    description:"(#2 w serii)
...
Powieść otrzymała tytuł „Książki Roku 2005”, przyznany przez Polską Sekcję IBBY"})

CREATE (FNiN_PS:Book {
    title:"Felix, Net i Nika oraz Pałac Snów", 
    cover_photo:"https://powergraph.pl/uploads/catalog/product/cover/35/large_Felix_PS_front_500.jpg", 
    genres:["fantasy", "science-fiction", "teen"], 
    description:"(#3 w serii)
...
CREATE (FNiN_PN:Book {
    ...
    cover_photo:"https://powergraph.pl/uploads/catalog/product/cover/36/large_Felix_PN_front_500.jpg", 
    genres:["fantasy", "science-fiction", "teen"], 
    description:"(#4 w serii)
...
CREATE (FNiN_OS:Book {
    title:"Felix, Net i Nika oraz Orbitalny Spisek", 
    cover_photo:"https://powergraph.pl/uploads/catalog/product/cover/37/large_Felix_OS_front_500.jpg", 
    genres:["fantasy", "science-fiction", "teen"], 
    description:"(#5 w serii)
...
CREATE (FNiN_OS2:Book {
    title:"Felix, Net i Nika oraz Orbitalny Spisek 2: Mała Armia", 
    cover_photo:"https://powergraph.pl/uploads/catalog/product/cover/38/large_Felix_OS2_front_500.jpg", 
    genres:["fantasy", "science-fiction", "teen"], 
    description:"(#6 w serii)
...
CREATE (FNiN_3K:Book {
    title:"Felix, Net i Nika oraz Trzecia Kuzynka", 
    cover_photo:"https://powergraph.pl/uploads/catalog/product/cover/106/large_Felix_3K_front_500.jpg", 
    genres:["fantasy", "science-fiction", "teen"], 
    description:"(#7 w serii)
...
CREATE (FNiN_BM:Book {
    title:"Felix, Net i Nika oraz Bunt Maszyn", 
    cover_photo:"https://powergraph.pl/uploads/catalog/product/cover/40/large_FNiN_BM_front_500.jpg", 
    genres:["fantasy", "science-fiction", "teen"], 
    description:"(#8 w serii)
...
CREATE (FNiN_Ś0:Book {
    ...
    cover_photo:"https://powergraph.pl/uploads/catalog/product/cover/41/large_felix_SZ_front_500.jpg", 
    genres:["fantasy", "science-fiction", "teen"], 
    description:"(#9 w serii)
...
CREATE (FNiN_Ś02:Book {
    title:"Felix, Net i Nika oraz Świat Zero 2. Alternauci", 
    cover_photo:"https://powergraph.pl/uploads/catalog/product/cover/42/large_Felix_SZ2_front_500.jpg", 
    genres:["fantasy", "science-fiction", "teen"], 
    description:"(#10 w serii)
...
CREATE (FNiN_NH:Book {
    title:"Felix, Net i Nika oraz Nadprogramowe Historie", 
    cover_photo:"https://powergraph.pl/uploads/catalog/product/cover/43/large_Felix_NH_front_500.jpg", 
    genres:["fantasy", "science-fiction", "teen"], 
    description:"(#11 w serii)
Trójka kultowych gimnazjalistów opisana tym razem w przezabawnych, trzymających w napięciu opowiadaniach. Oto Felix, Net i Nika zaplątani w miłosną aferę szkolnych walentynek, zagadkę mutacji genetycznych w odciętej od świata wiosce i w sen-pułapkę, z którego nie można się obudzić.
Smakowite nadprogramowe historie można czytać niezależnie od książek serii!"})

CREATE (FNiN_SCH:Book {
    title:"Felix, Net i Nika oraz Sekret Czerwonej Hańczy", 
    cover_photo:"https://powergraph.pl/uploads/catalog/product/cover/44/large_Felix_SCH_front_500.jpg", 
    genres:["fantasy", "science-fiction", "teen"], 
    description:"(#12 w serii)
...
CREATE (FNiN_KDM:Book {
    title:"Felix, Net i Nika oraz Klątwa Domu McKillianów", 
    cover_photo:"https://powergraph.pl/uploads/catalog/product/cover/45/large_Felix_KDM_front_500.jpg", 
    genres:["fantasy", "science-fiction", "teen"], 
    description:"(#13 w serii)
...
CREATE (FNiN_nBD:Book {
    title:"Felix, Net i Nika oraz (nie)Bezpieczne Dorastanie", 
    cover_photo:"https://powergraph.pl/uploads/catalog/product/cover/46/large_Felix_nBD_front_500.jpg", 
    genres:["fantasy", "science-fiction", "teen"], 
    description:"(#14 w serii)
...
CREATE (FNiN_KŚJZ:Book {
    title:"Felix, Net i Nika oraz Koniec Świata Jaki Znamy", 
    cover_photo:"https://powergraph.pl/uploads/catalog/product/cover/97/large_KSJZ_front_1000.jpg", 
    genres:["fantasy", "science-fiction", "teen"], 
    description:"(#15 w serii)
...
CREATE (FNiN_ZS:Book {
    title:"Felix, Net i Nika oraz Zero Szans", 
    cover_photo:"https://powergraph.pl/uploads/catalog/product/cover/214/large_Felix_ZS1_front_preview_1000.jpg", 
    genres:["fantasy", "science-fiction", "teen"], 
    description:"#16 w serii
...
CREATE
(RKosik)<-[:WRITTEN_BY]-(FNiN_GNL)-[:RELEASED_BY {release_date:date("2004-11-01")}]->(powergraph),
(RKosik)<-[:WRITTEN_BY]-(FNiN_TMK)-[:RELEASED_BY {release_date:date("2005-11-01")}]->(powergraph),
(RKosik)<-[:WRITTEN_BY]-(FNiN_PS)-[:RELEASED_BY {release_date:date("2006-11-01")}]->(powergraph),
(RKosik)<-[:WRITTEN_BY]-(FNiN_PN)-[:RELEASED_BY {release_date:date("2007-11-26")}]->(powergraph),
(RKosik)<-[:WRITTEN_BY]-(FNiN_OS)-[:RELEASED_BY {release_date:date("2008-11-14")}]->(powergraph),
(RKosik)<-[:WRITTEN_BY]-(FNiN_OS2)-[:RELEASED_BY {release_date:date("2009-05-22")}]->(powergraph),
(RKosik)<-[:WRITTEN_BY]-(FNiN_3K)-[:RELEASED_BY {release_date:date("2009-11-25")}]->(powergraph),
(RKosik)<-[:WRITTEN_BY]-(FNiN_BM)-[:RELEASED_BY {release_date:date("2011-03-18")}]->(powergraph),
(RKosik)<-[:WRITTEN_BY]-(FNiN_Ś0)-[:RELEASED_BY {release_date:date("2011-11-09")}]->(powergraph),
(RKosik)<-[:WRITTEN_BY]-(FNiN_Ś02)-[:RELEASED_BY {release_date:date("2012-11-07")}]->(powergraph),
(RKosik)<-[:WRITTEN_BY]-(FNiN_NH)-[:RELEASED_BY {release_date:date("2013-04-17")}]->(powergraph),
(RKosik)<-[:WRITTEN_BY]-(FNiN_SCH)-[:RELEASED_BY {release_date:date("2013-11-20")}]->(powergraph),
(RKosik)<-[:WRITTEN_BY]-(FNiN_KDM)-[:RELEASED_BY {release_date:date("2014-11-19")}]->(powergraph),
(RKosik)<-[:WRITTEN_BY]-(FNiN_nBD)-[:RELEASED_BY {release_date:date("2015-11-18")}]->(powergraph),
(RKosik)<-[:WRITTEN_BY]-(FNiN_KŚJZ)-[:RELEASED_BY {release_date:date("2018-11-28")}]->(powergraph),
(RKosik)<-[:WRITTEN_BY]-(FNiN_ZS)-[:RELEASED_BY {release_date:date("2022-11-23")}]->(powergraph)

CREATE (AKańtoch:Author {name:'Anna', surname:'Kańtoch', born:date("1976-12-28")})
CREATE (Czarne:Book{
    title:"Czarne",
    cover_photo:"https://powergraph.pl/uploads/catalog/product/cover/6/large_kantoch_czarne_front_500.jpg", 
    description:"Czarne to letnisko, gdzie spędza wakacje rodzina bohaterki książki. Opowieść, w którą wplatają się dramatyczne losy pięknej aktorki Jadwigi Rathe – muzy ojca narratorki, rozgrywa się w letnie miesiące lat: 1893, 1914 i 1935. Warszawskie kawiarnie, spotkania w Towarzystwie Spirytystycznym, leniwa atmosfera podwieczorków w starym dworku i budzący się erotyzm nastolatki tworzą niepowtarzalny klimat powieści.
Czytelnik powoli odkrywa, czym są tak naprawdę wspomnienia narratorki i jaką tajemnicę skrywa rok 1863, rok Powstania.", 
    genres:["fiction"]})

CREATE (ZabawkiD:Book{
    title:"Zabawki diabła",
    cover_photo:"https://powergraph.pl/uploads/catalog/product/cover/103/large_Kantoch_Zabawki_diabla_front_500.jpg", 
    description:"Domenic Jordan (tom 2)
...
CREATE (TAanioł:Book{
    title:"Trzynasty anioł",
    cover_photo:"https://powergraph.pl/uploads/catalog/product/cover/70/large_kantoch_13_aniol_front_500.jpg", 
    description:"Kryminał w konwencji urban fantasy, w którym w niebanalnej scenografii rozgrywa się dynamiczna, precyzyjnie rozplanowana intryga.
...
CREATE (FabrykaS:Publishing_House {name:"Fabryka Słów"})

CREATE
(AKańtoch)<-[:WRITTEN_BY]-(Czarne)-[:RELEASED_BY {release_date:date("2012-10-05")}]->(powergraph),
